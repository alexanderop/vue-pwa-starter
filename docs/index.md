...
| [Functional core, imperative shell](functional-core.md) | Deciding where a piece of logic lives — a component, a composable, or a plain `.ts` module — or hitting a complexity/determinism lint rule  |
...
| [Touch conventions](touch-conventions.md)               | Anything a finger touches — a new control, the app shell, a safe-area inset, or a sheet                                                     |
