...
export const A11Y_COVERAGE = {
  ...
  'components/PageLayout.vue': 'settings',
  'components/PwaInstallDialog.vue': 'installDialog',
  'components/PwaInstallPrompt.vue': 'installBanner',
  'components/PwaUpdatePrompt.vue': 'updateBanner',
  'components/ToastViewport.vue': 'toast',
